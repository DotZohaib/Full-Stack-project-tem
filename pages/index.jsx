...
export default function Home() {
  return (
    <>
      <Head>
        ...
        <meta name="description" content="This is E-Commerce WebSite like ZenZone" />
  ...
  <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
    <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
      ...
      <span className='ml-14 text-xs -mb-4  '>5</span>
      <p className="mb-8 leading-relaxed">Copper <br></br> mug try-hard pitchfork  pour-over freegan heirloom neutra air plant cold-pressed tacos poke beard tote bag. Heirloom echo park mlkshk tote bag selvage hot chicken authentic tumeric truffaut hexagon try-hard chambray.</p>
    ...
    <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
      <img className="object-cover object-center rounded" alt="hero" src="https://www.gulahmedshop.com/media/catalog/product/g/l/gls-23-196_4_.jpg?optimize=medium&fit=bounds&height=&width="/>
    </div>
  </div>
</section>
    ...
    <div className="flex flex-wrap -m-2">
      <div className="p-2 lg:w-1/3 md:w-1/2 w-full">
        <div className="h-full flex items-center border-gray-200 border p-4 rounded-lg">
          <img alt="team" className="w-16 h-16 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-4" src="https://www.gulahmedshop.com/media/catalog/product/g/l/gls-23-196_4_.jpg?optimize=medium&fit=bounds&height=&width="/>
      ...
      <div className="p-2 lg:w-1/3 md:w-1/2 w-full">
        <div className="h-full flex items-center border-gray-200 border p-4 rounded-lg">
          <img alt="team" className="w-16 h-16 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-4" src="hhttps://www.gulahmedshop.com/media/catalog/product/g/l/gls-23-196_4_.jpg?optimize=medium&fit=bounds&height=&width="/>
          <div className="flex-grow">
